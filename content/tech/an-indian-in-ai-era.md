---
title: An Indian Software Engineer in an AI Era
date: 2026-07-30
eyebrow: AI
description: Why the Indian habit of translating everything, for everyone, all the time, is the AI era's most underrated skill.
...
I used to think this was a party trick. Turns out, it was training data.

## The job changed under us

Here's what happened to our industry, in case you were on a very long vacation: software engineering quietly became a language job.

For decades, the game was: learn a programming language, speak to the machine in that language only, and the machine does what you say (eventually, after four Stack Overflow tabs). Precision was everything. Miss a semicolon (or a tab or even a space, thanks to yaml) and the compiler would sulk for an hour.

Now? The most valuable skill in the room is describing what you want to a system that understands *intent*, not just syntax. The bottleneck moved from "can you write the code" to "can you explain the problem." And explaining a problem clearly - to an entity that is powerful, slightly literal, *always* overconfident - is not a new experience for anyone who has ever coordinated an Indian family function over a WhatsApp group.

## We switch languages all day anyway

The average Indian professional performs live translation all day, and I don't mean between Tamil and English. I mean between *registers*:
...
Every generation of Indian techies has had to reinvent itself. Mainframes to Y2K to services to product to startups to now this. We have watched job titles appear and evaporate like monsoon rains and mango showers. We had generations that - reviewed code with printout-comparisons of old and new code, deployed code with floppy disc (oh yes we had such a peripheral!), ran java compilation with javac command on terminal, used Textpad as a national standard IDE. And today, industry that once ran on, "learn Java, retire on Java" now runs on "the framework you learned in January is legacy by Diwali."

This constant reinvention built an adaptation muscle that is suddenly the most relevant muscle in tech. Because AI isn't a technology shift you learn once. It's a treadmill. The models change quarterly. The best practices change monthly. The only stable skill is the meta-skill: absorb the new thing, map it to what you know, keep moving, complain about it over chai, adapt anyway.
